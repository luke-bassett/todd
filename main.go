...
func (a *Agent) Run(ctx context.Context) error {
	...
	fmt.Println("Chat with Todd (use 'ctrl-c' to quit)")
...
var ReadFileDefinition = ToolDefinition{
	Name:        "read_file",
	Description: "Read the contents of a give relative file path. Use this when you want to see what's inside a file. Do no use this with directory names.",
